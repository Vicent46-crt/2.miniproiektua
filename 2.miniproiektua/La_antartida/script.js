...
function marraztu() {
    ...
    karratuak = [];
    karratua_marraztu(hutsunea * 0, canvas.height - Altuera * 1.5, zabalera, Altuera * 1.5);
    karratua_marraztu(hutsunea * 2 + zabalera, canvas.height - Altuera, zabalera, Altuera);
...
function gameLoop() {
    ...
    if (checkBanderaCollision(pilota, banderaX, banderaY)) {
        // alert("EPAAA");
        window.location.href = '../Cocina/main.html'; // Cambia la URL al siguiente nivel
    }
