...
function marraztu() {
    ...
    const zabalera = canvas.width * 0.2;
    const Altuera = canvas.height * 0.3;
    const hutsunea = canvas.width * 0.15;

    karratuak = [];
    karratua_marraztu(hutsunea * 4 + zabalera * 3, canvas.height - Altuera, zabalera, Altuera);
    karratua_marraztu(hutsunea * 2 + zabalera, canvas.height - Altuera * 1.5, zabalera, Altuera * 1.5);
    karratua_marraztu(hutsunea * 3 + zabalera * 2, canvas.height - Altuera * 0.8, zabalera, Altuera * 0.8);
    karratua_marraztu(hutsunea * 0, canvas.height - Altuera * 2.5, zabalera, Altuera * 4);
...
function gameLoop() {
    ...
    if (checkBanderaCollision(pilota, banderaX, banderaY)) {
        // alert("EPAAA");
        window.location.href = '../Amaierako_Pantaila/Pantalla_Final.html'; // Cambia la URL al siguiente nivel
    }
